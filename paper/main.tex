...
% ============================================================
% References (inlined from IEEEtran.bst output)
% ============================================================
...
\bibitem{maurya2024datastates}
A.~Maurya, U.~Robert, F.~Cappello, and B.~Nicolae, ``{DataStates-LLM}: Lazy
  asynchronous checkpointing for large language models,'' in \emph{IEEE
  International Parallel and Distributed Processing Symposium (IPDPS)}, 2024.

\bibitem{nie2025llada}
S.~Nie, F.~Zhu, C.~You, X.~Zhang, J.~Ou, J.~Hu, J.~Zhou, Y.~Lin, J.-R. Wen, and
  Z.~Li, ``Large language diffusion models,'' \emph{arXiv preprint
...
S.~S. Sahoo, M.~Arriola, Y.~Schiff, A.~Gokaslan, E.~Marroquin, J.~T. Chiu,
...
\bibitem{lou2024sedd}
A.~Lou, C.~Meng, and S.~Ermon, ``Discrete diffusion modeling by estimating the
  ratios of the data distribution,'' in \emph{International Conference on
  Machine Learning (ICML)}, 2024.

\bibitem{grubic2024olmotrace}
o.~Grubic, ``{OLMoTrace}: Tracing language model outputs back to trillions of
  training tokens,'' \emph{arXiv preprint arXiv:2504.07096}, 2025.

\bibitem{xu2025modelprovenance}
o.~Xu, ``Model provenance testing for large language models,'' \emph{arXiv
  preprint arXiv:2502.00706}, 2025.

\bibitem{nicolae2020veloc}
B.~Nicolae, A.~Li, J.~Chen, S.~Zheng, A.~Moody, and F.~Cappello, ``{VeloC}:
  Very low overhead checkpointing system,'' in \emph{IEEE/ACM International
  Conference on High Performance Computing, Networking, Storage and Analysis
  (SC)}, 2020.

\bibitem{di2016sz}
S.~Di and F.~Cappello, ``Fast error-bounded lossy {HPC} data compression with
  {SZ},'' in \emph{IEEE International Parallel and Distributed Processing
  Symposium (IPDPS)}, 2016.

\bibitem{underwood2022libpressio}
R.~Underwood, V.~Malvoso, J.~C. Calhoun, S.~Di, and F.~Cappello, ``Productive
  and performant generic lossy data compression with {LibPressio},'' in
  \emph{IEEE International Workshop on Accelerating Analytics and Computing
  (ACCEL)}, 2022.

\bibitem{nie2025llada2}
S.~Nie \emph{et~al.}, ``LLaDA2.0: Scaling up diffusion language models to
  100B,'' \emph{arXiv preprint arXiv:2512.15745}, 2025.
...
M.~Shoeybi, M.~Patwary, R.~Puri, P.~LeGresley, J.~Casper, and B.~Catanzaro,
  ...
  parallelism,'' in \emph{arXiv preprint arXiv:1909.08053}, 2019.

\bibitem{chen2024dinfer}
J.~Chen \emph{et~al.}, ``dInfer: An efficient inference framework for diffusion
  language models,'' \emph{arXiv preprint arXiv:2510.08666}, 2025.

\bibitem{chen2024fastdllm}
o.~Chen, ``Fast-dLLM: Training-free fast diffusion large language model
  inference,'' \emph{NeurIPS}, 2025.
...
J.~Rasley, S.~Rajbhandari, O.~Ruwase, and Y.~He, ``{DeepSpeed}: System
  ...
  parameters,'' in \emph{ACM SIGKDD International Conference on Knowledge
  Discovery \& Data Mining}, 2020.

\bibitem{amd2024mi300x}
{AMD}, ``{AMD Instinct MI300X} accelerator,''
...
J.~Austin, D.~D. Johnson, J.~Ho, D.~Tarlow, and R.~van~den Berg, ``Structured
  denoising diffusion models in discrete state-spaces,'' in \emph{Advances in
  Neural Information Processing Systems (NeurIPS)}, 2021.

\bibitem{underwood2021compression}
R.~R. Underwood, ``Approachable error bounded lossy compression,'' Ph.D.
  dissertation, Clemson University, 2021.

\bibitem{heroux2024reproducibility}
M.~A. Heroux \emph{et~al.}, ``Toward a new metric for ranking {HPC} systems:
  Reproducibility,'' \emph{Computing in Science \& Engineering}, 2024.

\bibitem{cappello2014resilience}
F.~Cappello, A.~Geist, B.~Gropp, S.~Kale, B.~Kramer, and M.~Snir, ``Toward
  exascale resilience: 2014 update,'' \emph{Supercomputing Frontiers and
